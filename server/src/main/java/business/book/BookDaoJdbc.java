...
public class BookDaoJdbc implements BookDao {
    ...
    private Book readBook(ResultSet resultSet) throws SQLException {
        // TODO add description, isFeatured, rating to Book results //Done
        ...
        return new Book(bookId, title, author, description, rating, isFeatured, price, isPublic, categoryId);
    }
}
